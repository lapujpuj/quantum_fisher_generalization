...
depth=20 #20 ##depth of quantum circuit
...
plt.plot(n_training_list,rank_DQFIM_list, label ="R_L")
plt.ylabel(r'R_L')
plt.xlabel("L")
plt.legend(loc="upper right")
plt.title("Rank of data DQFIM vs number of training states")
plt.savefig("figure/Rank_DQFIM_vs_training_states.png")
# plt.show()
